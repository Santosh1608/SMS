...
export const listCourses = async (req, res) => {
  try {
    ...
    const query = `SELECT DISTINCT * FROM Country JOIN University ON Country.country_id = University.country_id 
                             ...
                             JOIN Scholarship ON Scholarship.university_id = University.university_id AND 
                             Scholarship.level_id = EducationLevel.level_id
